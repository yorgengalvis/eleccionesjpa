...
<header>
   ...
   <main>
    <div class="row p-2">
        ...
        <div class="col-sm-4 tx-center"><a class="btn bg-red w-50" href="#">Cerrar sesion</a></div>
    </div>
                ...
                <div class="input-group justify-content-center">
                    <div class="row">
                        <div class="col-sm-5 mb-3">
                            <div class="card">
                                <a href="estudianteselecciona.html">
                                    <div class="card-header bg-red ">
                                        <p class="tx-center"><img class="candidate" src="https://w2.ufps.edu.co/public/imagenes/rectoria/hector_miguel_parra_lopez.jpg"/></p>
                                        <p class="tx-center">Hector Miguel Parra</p>
                                    </div>
                                </a>
                            </div>
                        </div>
