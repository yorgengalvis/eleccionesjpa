...
<title>Candidatos | Votaciones</title>
</head>
<body>
           ...
           <a href="admin" class="btn bg-red m-2">Regresar</a>
               ...
               <div class="col-sm-4">
					...
					<div class="card">
						...
						<div class="card-body">
						<c:if test="${candidato==null}">
						<form action="candidatos?action=add" method="POST">
						</c:if>
						<c:if test="${candidato!=null}">
						<form action="candidatos?action=update&id=${candidato.id}" method="POST">
                   ...
                   <div class="card-body">
                        <div class="table-responsive mt-2">
                            <table id="table_id" class="display mt-5">
                                ...
                                <tbody>
                                <c:forEach var="candidato" items="${listado}">
                                 	<tr>
                                 		<td><c:out value="${candidato.id}"></c:out></td>
                                 		<td><c:out value="${candidato.documento}"></c:out></td>
                                 		<td><c:out value="${candidato.nombre}"></c:out></td>
                                 		<td><c:out value="${candidato.apellido}"></c:out></td>
                                 		<td><c:out value="${candidato.eleccion.nombre}"></c:out></td>
                                 		<td><c:out value="${candidato.numero}"></c:out></td>
                                 		<th><a class="p-1 br-2 bg-red" href="candidatos?action=edit&id=${candidato.id}"><i class="fa fa-edit"></i></a><a class="p-1 br-2 bg-red" href="candidatos?action=delete&id=${candidato.id}"><i class="fa fa-times"></i></a></th>
                                 	</tr>
                                </c:forEach>
                                </tbody>
                            </table>
